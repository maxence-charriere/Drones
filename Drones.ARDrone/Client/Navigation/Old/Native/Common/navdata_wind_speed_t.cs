...
namespace Drones.ARDrone.Client.Navdata.Native.Common
{
    ...
    public struct navdata_wind_speed_t
    {
        ...
        /// <summary> Estimated wind speed [m/s]. </summary>
        public float wind_speed;

        /// <summary>
        /// Estimated wind direction in North-East frame [rad] e.g. if wind_angle is pi/4, wind
        /// is from South-West to North-East.
        /// </summary>
